...
4. Registers Zotero Linker under the machine and current-user Word add-in registry keys.
...
8. Adds the WPS Writer whitelist values for the current user and machine.
9. Cleans old Zotero Linker VSTO registry/cache data during upgrade and uninstall.
