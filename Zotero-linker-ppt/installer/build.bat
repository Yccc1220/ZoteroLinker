...
:: Zotero Linker PPT VSTO installer builder
...
echo ============================================
echo  Zotero Linker PPT Installer Build
echo  Version: %VERSION%
echo  Configuration: %CONFIG%
echo ============================================

echo [1/2] Building PowerPoint VSTO add-in...
...
echo  Output: %DIST_DIR%\ZoteroLinkerPptSetup-%VERSION%.exe
echo ============================================
