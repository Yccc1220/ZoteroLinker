...
$addInName = "Zotero-linker-ppt"
$displayName = "Zotero Linker PPT"
$legacyWpsWhitelistName = "Yccc1220.Zotero Linker PPT"
$tokens = @("Zotero-linker-ppt", "Zotero Linker PPT", "Zotero_linker_ppt")
...
$officeAddinRoots = @(
    "HKLM:\Software\Microsoft\Office\PowerPoint\Addins\$addInName",
    "HKLM:\Software\Microsoft\Office\16.0\PowerPoint\Addins\$addInName",
    "HKLM:\Software\WOW6432Node\Microsoft\Office\PowerPoint\Addins\$addInName",
    "HKLM:\Software\WOW6432Node\Microsoft\Office\16.0\PowerPoint\Addins\$addInName",
    ...
    "HKLM:\Software\Microsoft\Office\ClickToRun\REGISTRY\MACHINE\Software\Microsoft\Office\PowerPoint\Addins\$addInName",
    "HKLM:\Software\Microsoft\Office\ClickToRun\REGISTRY\MACHINE\Software\Microsoft\Office\16.0\PowerPoint\Addins\$addInName",
    "HKLM:\Software\WOW6432Node\Microsoft\Office\ClickToRun\REGISTRY\MACHINE\Software\Microsoft\Office\PowerPoint\Addins\$addInName",
    "HKLM:\Software\WOW6432Node\Microsoft\Office\ClickToRun\REGISTRY\MACHINE\Software\Microsoft\Office\16.0\PowerPoint\Addins\$addInName",
    "HKCU:\Software\Kingsoft\Office\WPP\AddinsWL\$addInName",
    "HKLM:\Software\Kingsoft\Office\WPP\AddinsWL\$addInName",
    "HKCU:\Software\Kingsoft\Office\WPP\AddinsWL\$legacyWpsWhitelistName",
    "HKLM:\Software\Kingsoft\Office\WPP\AddinsWL\$legacyWpsWhitelistName"
)
...
$wpsWhitelistRoots = @(
    ...
    "HKLM:\Software\Kingsoft\Office\WPP\AddinsWL",
    "HKLM:\Software\WOW6432Node\Kingsoft\Office\WPP\AddinsWL"
)
...
$resiliencyRoots = @(
    "HKCU:\Software\Microsoft\Office\PowerPoint\Addins\$addInName",
    "HKCU:\Software\Microsoft\Office\16.0\PowerPoint\Addins\$addInName",
    "HKCU:\Software\Microsoft\Office\16.0\PowerPoint\Resiliency\DisabledItems",
    "HKCU:\Software\Microsoft\Office\16.0\PowerPoint\Resiliency\StartupItems"
)
